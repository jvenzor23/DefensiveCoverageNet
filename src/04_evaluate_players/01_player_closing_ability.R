...
write.csv(closing_ability3,
          "~/Desktop/CoverageNet/src/04_evaluate_players/outputs/player_closing_eps.csv",
          row.names = FALSE)

write.csv(players_extreme_closing_ability,
          "~/Desktop/CoverageNet/src/04_evaluate_players/outputs/dashbaord_player_closing_eps_plays_viz.csv",
          row.names = FALSE)
...
write.csv(routes_closing_ability,
          "~/Desktop/CoverageNet/src/04_evaluate_players/outputs/player_closing_eps_by_route.csv",
          row.names = FALSE)
