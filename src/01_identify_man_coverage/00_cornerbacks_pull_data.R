# This script pulls data on all cornerbacks that are in pass coverage.
...
for(file in files){
  ...
  write.csv(pass_attempt_total2,
            "~/Desktop/CoverageNet/src/01_identify_man_coverage/outputs/corners_pass_attempts_man_zone_gmm_features.csv",
            row.names = FALSE)
  
  write.csv(sack_total2,
            "~/Desktop/CoverageNet/src/01_identify_man_coverage/outputs/corners_sacks_man_zone_gmm_features.csv",
            row.names = FALSE)
