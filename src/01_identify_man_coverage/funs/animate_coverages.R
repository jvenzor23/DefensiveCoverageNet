animate_coverages <- function(week, 
                              gameId_ex,
                              playId_ex) {
  ...
  pbp_data = read.csv(paste0("~/Desktop/CoverageNet/src/00_data_wrangle/outputs/week",
  week,
  ".csv"))
  ...
  return(list("animate.play" = animate.play,
         "play.length.ex" = play.length.ex))
